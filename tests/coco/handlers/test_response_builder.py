...
from coco.handlers.response_builder import build_response_parts
from coco.transcript_parser import TranscriptParser
...
class TestBuildResponseParts:
    ...
    def test_progress_preserves_leading_whitespace_for_deltas(self):
        parts = build_response_parts(
            " to",
            is_complete=True,
