"""Shared fixtures for CoCo unit tests.
...
def _memory_log_path(tmp_path, monkeypatch):
    """Keep Telegram memory log writes inside per-test temp dirs."""
    path = str(tmp_path / "TELEGRAM_CHAT_MEMORY.jsonl")
    monkeypatch.setenv(
